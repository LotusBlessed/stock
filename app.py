...
def index():
    ...
    return render_template("index.html", portfolio=portfolio_data, updated_time=taipei_time, summary=summary)


import os

if __name__ == "__main__":
    port = int(os.environ.get("PORT", 5000))  # Render 指定的 port
    print(f"[✅ Flask 正在啟動於 PORT {port}]")
